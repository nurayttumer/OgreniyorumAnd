package com.example.nurayt.ogreniyorumand;
...
import com.example.nurayt.ogreniyorumand.Model.Data;
    ...
    private void customDialog(){
        ...
        btnSave.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (TextUtils.isEmpty(mAmount) || (amount.getText().toString().trim()==null  )        ){

                    amount.setError("Required Field..");
                    amount.setText("0");

                    return;
                }  else {  ammint=Integer.parseInt(mAmount); }
                ...
                Toast.makeText(getApplicationContext(),"Bilgi Eklendi",Toast.LENGTH_SHORT).show();
